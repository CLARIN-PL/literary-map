 ...
 * generated in the pl.edu.pwr.services.morpho package. 
...
public class ObjectFactory {
    ...
    private final static QName _CheckStatusResponse_QNAME = new QName("http://156.17.134.60/ws/morpho/", "CheckStatusResponse");
    private final static QName _GetResultJSON_QNAME = new QName("http://156.17.134.60/ws/morpho/", "GetResultJSON");
    private final static QName _CheckStatus_QNAME = new QName("http://156.17.134.60/ws/morpho/", "CheckStatus");
    private final static QName _GetResultResponse_QNAME = new QName("http://156.17.134.60/ws/morpho/", "GetResultResponse");
    private final static QName _SendRequest_QNAME = new QName("http://156.17.134.60/ws/morpho/", "SendRequest");
    private final static QName _SendRequestResponse_QNAME = new QName("http://156.17.134.60/ws/morpho/", "SendRequestResponse");
    private final static QName _GetResult_QNAME = new QName("http://156.17.134.60/ws/morpho/", "GetResult");
    private final static QName _GetResultJSONResponse_QNAME = new QName("http://156.17.134.60/ws/morpho/", "GetResultJSONResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pl.edu.pwr.services.morpho
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "CheckStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "GetResultJSON")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "CheckStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "GetResultResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "SendRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "SendRequestResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "GetResult")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://156.17.134.60/ws/morpho/", name = "GetResultJSONResponse")
