...
public class PhpTaggerWebserviceClient implements WebserviceClient {
 
    public static final String USER_AGENT = "Mozilla/5.0";
    private static final String URL_SEND_TEXT = "http://www.clarin-pl.eu/synatold/ws/tagger/send.php";
    private static final String URL_CHECK_STATUS = "http://www.clarin-pl.eu/synatold/ws/tagger/check.php";
    private static final String URL_GET_RESULTS = "http://www.clarin-pl.eu/synat/ws/tagger/results.php";
    private static final String STATUS_READY = "READY";
    private static final String STATUS_PROCESSING = "PROCESSING";
    private static final String STATUS_QUEUED = "QUEUED";
    private static final int SERVICE_STATUS_CHECK_INTERVAL = 400; // in milliseconds
    private static final int SERVICE_WAIT_FOR_RESULTS_MAX_TIME = 30000; // in milliseconds
