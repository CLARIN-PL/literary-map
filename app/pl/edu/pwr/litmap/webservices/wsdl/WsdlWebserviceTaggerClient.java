...
import pl.edu.pwr.services.tagger.TaggerService;

public class WsdlWebserviceTaggerClient extends WsdlWebserviceClient {

	private TaggerService service = new TaggerService();
	private IServicePortType servicePort = new pl.edu.pwr.services.taggerAdapter.ServicePortType(service.getTaggerServicePort());
	private final static String SERVICE_NAME = "Tagger";
